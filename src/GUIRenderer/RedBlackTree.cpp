...
Node* RedBlackTree::query_rec(Component* comp, Node* suspect) {
...
void RedBlackTree::harderPaintingProblems(Node* repaintingNode) {
    Node* family;
...
Node* RedBlackTree::query(Component* comp) {
    return query_rec(comp, this->root);
}

void RedBlackTree::rotationLeft(Node* center) {
...
void RedBlackTree::rotationRight(Node* center) {
...
void RedBlackTree::add(Component* comp) {
